    ...
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto max-w-5xl px-4 py-14">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-[#6633ff]/10 p-3">
              <Code2 className="h-7 w-7 text-[#6633ff]" />
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-gray-500">
                ...
                for React, JavaScript, HTML, CSS, Next.js and more.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <div className="rounded-xl border bg-white px-5 py-3 shadow-sm">
              <p className="text-2xl font-bold text-[#6633ff]">
                {questions.length}
              </p>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        <Accordion type="single" collapsible className="space-y-4">
          {questions.map((item, index) => (
            ...
            >
              ...
              <AccordionContent className="border-t bg-gray-50 px-6 py-5">
                <div className="flex gap-3">
                  <BookOpen className="mt-1 h-5 w-5 text-[#6633ff]" />
        ...
        <div className="mt-10 rounded-2xl border border-blue-100 bg-blue-50 p-6">
          <div className="flex items-center gap-3">
            <BadgeCheck className="text-[#6633ff]" />
          ...
          <ul className="mt-5 space-y-3 text-gray-700">
            ...
            <li>✔ Practice coding instead of memorizing answers.</li>
            <li>✔ Review your recent React & Next.js projects.</li>
            <li>✔ Understand the "why" behind each concept.</li>
            <li>✔ Stay calm and communicate your thought process.</li>
          </ul>
        </div>
      </section>
    </main>
