...
const BuildCareer = () => {
    return (
        <section className="py-16 lg:py-24 bg-linear-to-br from-violet-50 via-white to-indigo-50">
            <div
                className="mx-auto grid max-w-7xl items-center gap-14 p-6 sm:p-8 md:grid-cols-2 md:p-12 lg:gap-20 lg:p-20">
                ...
                <div className=" flex justify-center">
                    <div className="relative flex w-full max-w-md flex-col items-center gap-6 md:h-105 md:max-w-none md:block">

                        {/* Card 1 */}
                        <div className="w-full max-w-sm rounded-3xl bg-white p-6 shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-2xl md:absolute md:right-0 md:top-0 md:w-80">
                        ...
                        {/* Card 2 */}
                        <div className="w-full max-w-sm rounded-3xl bg-white p-6 shadow-md transition duration-300 hover:-translate-y-2 hover:shadow-2xl md:absolute md:bottom-10 md:left-0 md:w-72">
